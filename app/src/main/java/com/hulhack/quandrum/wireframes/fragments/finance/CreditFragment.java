...
import com.hulhack.quandrum.wireframes.adapters.CreditAdapter;
...
public class CreditFragment extends Fragment {
    ...
    private static ArrayList<CreditModel> data;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        String URL="https://77ec4210.ngrok.io/credit?token="+token+"&id="+ id;

        final ArrayList<CreditModel> networkData = new ArrayList<CreditModel>();
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET,URL ,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        try {
                            pDialog.hide();
                            Log.i("credit response", response);
                            JSONArray netArray = new JSONArray(response);
                            for(int i=0; i<netArray.length();i++){
                                JSONObject obj = netArray.getJSONObject(i);
                                networkData.add(new CreditModel(
                                        obj.getString("Transaction_Type"), obj.getString("DOCUMENT_NO"), obj.getString("AMOUNT"), obj.getString("DATE_OF_DOCUMENT"), obj.getString("SHORT_DESC")));
                            }
        ...
        data = networkData;
        adapter = new CreditAdapter(data);
