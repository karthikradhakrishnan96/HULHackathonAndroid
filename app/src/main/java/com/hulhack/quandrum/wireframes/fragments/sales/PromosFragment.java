...
import com.hulhack.quandrum.wireframes.adapters.PromoAdapter;
...
public class PromosFragment extends Fragment {
    ...
    private static ArrayList<PromoModel> data;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        String URL="https://77ec4210.ngrok.io/promo?token="+token+"&id="+ id;

        final ArrayList<PromoModel> networkData = new ArrayList<PromoModel>();
                    ...
                    public void onResponse(String response) {
                        try {
                            ...
                            for(int i=0; i<netArray.length();i++){
                                ...
                                networkData.add(new PromoModel(
                                        obj.getString("Product"),
                                        obj.getString("Business"),
                                        obj.getString("Brand"),
                                        obj.getString("Promotion_Name"),
                                        obj.getString("Promotion_ID"),
                                        obj.getString("Investment_Type"),
                                        obj.getString("Promotion_Start_Date"),
                                        obj.getString("Promotion_End_Date")));
                            }
